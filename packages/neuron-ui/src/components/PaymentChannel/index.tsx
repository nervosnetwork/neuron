...
const Perun = () => {
  ...
  const [updateAmount, setUpdateAmount] = useState<number>(200)
  ...
  const [peerAmount, setPeerAmount] = useState<number>(200)
  ...
  return (
    ...
    >
      <div className={styles.header}>
        ...
        {/* 更新通道的弹窗 */}
        <Dialog show={!updateChannelDialog && channelID !== undefined} showFooter={false}>
          <Button
