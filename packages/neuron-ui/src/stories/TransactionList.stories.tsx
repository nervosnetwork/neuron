...
const story = storiesOf('TransactionList', module)
Object.keys(states).forEach(key => {
  story.add(states[key].title, () => <TransactionList walletID="1" items={states[key].list} dispatch={() => {}} />)
})
