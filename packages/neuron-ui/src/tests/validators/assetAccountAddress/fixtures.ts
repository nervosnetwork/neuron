...
export default {
  ...
  "Should throw an error when it's neither a full version address nor a acp short version address": {
    params: {
  ...
  "Should pass when account type is sudt and it's a short version address of secp256k1 lock": {
    params: {
