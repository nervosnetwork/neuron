...
jest.mock('dotenv', () => ({
  config: () => {
    ...
    process.env.LEGACY_MULTISIG_CODE_HASH = '0x5c5069eb0857efc65e1bca0c07df34c31663b3622fd3876c876320fc9634e2a8'
    process.env.MULTISIG_CODE_HASH = '0x36c971b8d41fbd94aabca77dc75e826729ac98447b46f91e00796155dddb0d29'
    process.env.MAINNET_MULTISIG_TXHASH = '0x6888aa39ab30c570c2c30d9d5684d3769bf77265a7973211a3c087fe8efbf738'
    process.env.TESTNET_MULTISIG_TXHASH = '0x2eefdeb21f3a3edf697c28a52601b4419806ed60bb427420455cc29a090b26d5'
