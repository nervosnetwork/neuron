...
describe('SystemScriptInfo', () => {
  ...
  const LEGACY_MULTI_SIGN_CODE_HASH = '0x5c5069eb0857efc65e1bca0c07df34c31663b3622fd3876c876320fc9634e2a8'
  const MULTI_SIGN_CODE_HASH = '0x36c971b8d41fbd94aabca77dc75e826729ac98447b46f91e00796155dddb0d29'
  ...
  const legacyMultiSignScript = SystemScriptInfo.generateMultiSignScript(
    '0x' + '0'.repeat(40),
    LEGACY_MULTI_SIGN_CODE_HASH
  )
  const multiSignScript = SystemScriptInfo.generateMultiSignScript('0x' + '0'.repeat(40), MULTI_SIGN_CODE_HASH)
  ...
  it('legacy multi sign code hash', () => {
    expect(SystemScriptInfo.LEGACY_MULTI_SIGN_CODE_HASH).toEqual(LEGACY_MULTI_SIGN_CODE_HASH)
  })
