export default {
  translation: {
    ...
    messages: {
      ...
      'current-wallet-is-not-set': 'Current wallet is not set',
      ...
      'network-is-not-found': 'Network of ID {{id}} is not found',
      'name-is-invalid': '{{field}} name is invalid',
