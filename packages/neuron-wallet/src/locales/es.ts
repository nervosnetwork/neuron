  ...
  translation: {
    ...
    messages: {
      ...
      'light-client-sudt-acp-error':
        'El modo cliente liviano no admite el envío de activos a la cuenta de activos de otra persona',
    ...
    'multisig-config': {
      ...
      'config-exported': 'Las configuraciones de multisig se han exportado a {{filePath}}.',
