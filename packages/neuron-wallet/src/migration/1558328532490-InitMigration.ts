...
export class InitMigration1558328532490 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "input" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "outPointTxHash" varchar, "outPointIndex" varchar, "args" text NOT NULL, "lockHash" varchar, "capacity" varchar, "transactionHash" varchar)`);
