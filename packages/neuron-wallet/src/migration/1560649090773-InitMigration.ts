...
export class InitMigration1560649090773 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "transaction" ("hash" varchar PRIMARY KEY NOT NULL, "version" varchar NOT NULL, "deps" text NOT NULL, "witnesses" text NOT NULL, "timestamp" varchar NOT NULL, "blockNumber" varchar NOT NULL, "blockHash" varchar NOT NULL)`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_input" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "outPointTxHash" varchar, "outPointIndex" varchar, "since" varchar NOT NULL, "lockHash" varchar, "capacity" varchar, "transactionHash" varchar, CONSTRAINT "FK_90ed760ab4ba57db62b3e798794" FOREIGN KEY ("transactionHash") REFERENCES "transaction" ("hash") ON DELETE CASCADE ON UPDATE NO ACTION)`);
        await queryRunner.query(`INSERT INTO "temporary_input"("id", "outPointTxHash", "outPointIndex", "since", "lockHash", "capacity", "transactionHash") SELECT "id", "outPointTxHash", "outPointIndex", "since", "lockHash", "capacity", "transactionHash" FROM "input"`);
