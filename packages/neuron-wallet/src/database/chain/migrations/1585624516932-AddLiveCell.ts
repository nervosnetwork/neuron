...
export class AddLiveCell1585624516932 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
      await queryRunner.query(`CREATE TABLE IF NOT EXISTS "live_cell" ("txHash" varchar NOT NULL, "outputIndex" integer NOT NULL, "capacity" varchar NOT NULL, "lockHash" character(32) NOT NULL, "lockHashType" character(1) NOT NULL, "lockCodeHash" character(32) NOT NULL, "lockArgs" varchar NOT NULL, "typeHash" character(32), "typeHashType" character(1), "typeCodeHash" character(32), "typeArgs" varchar, "data" varchar(64) NOT NULL, PRIMARY KEY ("txHash", "outputIndex"))`);
