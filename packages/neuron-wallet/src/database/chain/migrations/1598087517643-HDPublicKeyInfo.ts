...
export class HDPublicKeyInfo1598087517643 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query(`CREATE TABLE "hd_public_key_info" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "walletId" varchar NOT NULL, "address" varchar NOT NULL, "addressType" integer NOT NULL, "addressIndex" integer NOT NULL, "publicKeyInBlake160" varchar NOT NULL, "description" varchar, "createdAt" varchar NOT NULL DEFAULT (CURRENT_TIMESTAMP))`, undefined);
