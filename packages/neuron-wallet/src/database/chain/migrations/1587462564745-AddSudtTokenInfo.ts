...
export class AddSudtTokenInfo1587462564745 implements MigrationInterface {
    name = 'AddSudtTokenInfo1587462564745'

    public async up(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query(`CREATE TABLE "sudt_token_info" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "walletID" varchar NOT NULL, "tokenID" varchar NOT NULL, "symbol" varchar NOT NULL, "tokenName" varchar NOT NULL, "decimal" varchar NOT NULL)`, undefined);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_asset_account" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "walletID" varchar NOT NULL, "tokenID" varchar NOT NULL, "balance" varchar NOT NULL, "blake160" varchar NOT NULL, "accountName" varchar NOT NULL DEFAULT (''), "sudtTokenInfoId" integer, CONSTRAINT "FK_7628b66e875ecf0f9479a8068f9" FOREIGN KEY ("sudtTokenInfoId") REFERENCES "sudt_token_info" ("id") ON DELETE CASCADE ON UPDATE NO ACTION)`, undefined);
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`INSERT INTO "asset_account"("id", "walletID", "tokenID", "balance", "blake160", "accountName", "symbol", "decimal", "tokenName") SELECT "id", "walletID", "tokenID", "balance", "blake160", "accountName", "", "", "" FROM "temporary_asset_account"`, undefined);
